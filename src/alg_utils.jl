...
alg_compatible(prob::DiffEqBase.AbstractSDEProblem, alg::SOSRA) = is_diagonal_noise(prob)
alg_compatible(prob::DiffEqBase.AbstractSDEProblem, alg::SOSRA2) = is_diagonal_noise(prob)
