...
function SciMLBase.isautodifferentiable(alg::Union{StochasticDiffEqAlgorithm,
                                                   StochasticDiffEqRODEAlgorithm,
                                                   StochasticDiffEqJumpAlgorithm})
    true
end
function SciMLBase.allows_arbitrary_number_types(alg::Union{StochasticDiffEqAlgorithm,
                                                            StochasticDiffEqRODEAlgorithm,
                                                            StochasticDiffEqJumpAlgorithm})
    true
end
function SciMLBase.allowscomplex(alg::Union{StochasticDiffEqAlgorithm,
                                            StochasticDiffEqRODEAlgorithm,
                                            StochasticDiffEqJumpAlgorithm})
    true
end
...
function isadaptive(alg::Union{StochasticDiffEqAdaptiveAlgorithm,
                               StochasticDiffEqRODEAdaptiveAlgorithm,
                               StochasticDiffEqJumpAdaptiveAlgorithm,
                               StochasticDiffEqJumpDiffusionAdaptiveAlgorithm})
    true
end
function isadaptive(alg::Union{StochasticDiffEqCompositeAlgorithm,
                               StochasticDiffEqRODECompositeAlgorithm})
    all(isadaptive.(alg.algs))
end
function isadaptive(prob,
...
function qsteady_min_default(alg::Union{StochasticDiffEqAlgorithm,
                                        StochasticDiffEqRODEAlgorithm})
    1
end
function qsteady_max_default(alg::Union{StochasticDiffEqAlgorithm,
                                        StochasticDiffEqRODEAlgorithm})
    1
end
...
function alg_order(alg::Union{StochasticDiffEqCompositeAlgorithm,
                              StochasticDiffEqRODECompositeAlgorithm})
    maximum(alg_order.(alg.algs))
end
get_current_alg_order(alg::StochasticDiffEqAlgorithm, cache) = alg_order(alg)
function get_current_alg_order(alg::Union{StochasticDiffEqCompositeAlgorithm,
                                          StochasticDiffEqRODECompositeAlgorithm}, cache)
...
function beta1_default(alg::Union{StochasticDiffEqAlgorithm, StochasticDiffEqRODEAlgorithm},
                       beta2)
...
function alg_interpretation(alg::SROCK1{interpretation, E}) where {interpretation, E}
    interpretation
end
alg_interpretation(alg::RKMilCommute) = alg.interpretation
alg_interpretation(alg::RKMilGeneral) = alg.interpretation
function alg_interpretation(alg::ImplicitRKMil{CS, AD, F, P, FDT, ST, CJ, N, T2, Controller,
                                               interpretation}) where {CS, AD, F, P, FDT,
                                                                       ST, CJ, N, T2,
                                                                       Controller,
                                                                       interpretation}
    interpretation
...
function alg_compatible(prob::JumpProblem,
                        alg::Union{StochasticDiffEqJumpAdaptiveAlgorithm,
                                   StochasticDiffEqJumpAlgorithm})
    prob.prob isa DiscreteProblem
end

function alg_needs_extra_process(alg::Union{StochasticDiffEqAlgorithm,
                                            StochasticDiffEqRODEAlgorithm})
    false
end
function alg_needs_extra_process(alg::Union{StochasticDiffEqCompositeAlgorithm,
                                            StochasticDiffEqRODECompositeAlgorithm})
...
function OrdinaryDiffEq.alg_autodiff(alg::StochasticDiffEqNewtonAlgorithm{CS, AD, FDT, ST,
                                                                          CJ, Controller}) where {
                                                                                                  CS,
                                                                                                  AD,
                                                                                                  FDT,
...
function OrdinaryDiffEq.alg_autodiff(alg::StochasticDiffEqNewtonAdaptiveAlgorithm{CS, AD,
                                                                                  FDT, ST,
                                                                                  CJ,
                                                                                  Controller
                                                                                  }) where {
...
function OrdinaryDiffEq.alg_autodiff(alg::StochasticDiffEqJumpNewtonAdaptiveAlgorithm{CS,
                                                                                      AD,
                                                                                      FDT,
                                                                                      ST,
                                                                                      CJ,
...
function OrdinaryDiffEq.alg_autodiff(alg::StochasticDiffEqJumpNewtonDiffusionAdaptiveAlgorithm{
                                                                                               CS,
                                                                                               AD,
                                                                                               FDT,
                                                                                               ST,
...
function OrdinaryDiffEq.get_current_alg_autodiff(alg::StochasticDiffEqCompositeAlgorithm,
                                                 cache)
    OrdinaryDiffEq.alg_autodiff(alg.algs[cache.current])
end

function OrdinaryDiffEq.get_chunksize(alg::StochasticDiffEqNewtonAlgorithm{CS, AD, FDT, ST,
                                                                           CJ, Controller}) where {
                                                                                                   CS,
                                                                                                   AD,
                                                                                                   FDT,
...
function OrdinaryDiffEq.get_chunksize(alg::StochasticDiffEqNewtonAdaptiveAlgorithm{CS, AD,
                                                                                   FDT, ST,
                                                                                   CJ,
                                                                                   Controller
                                                                                   }) where {
...
function OrdinaryDiffEq.get_chunksize(alg::StochasticDiffEqJumpNewtonAdaptiveAlgorithm{CS,
                                                                                       AD,
                                                                                       FDT,
                                                                                       ST,
                                                                                       CJ,
...
function OrdinaryDiffEq.get_chunksize(alg::StochasticDiffEqJumpNewtonDiffusionAdaptiveAlgorithm{
                                                                                                CS,
                                                                                                AD,
                                                                                                FDT,
                                                                                                ST,
...
@static if isdefined(OrdinaryDiffEq, :standardtag)
    function OrdinaryDiffEq.standardtag(alg::Union{
                                                   ...
                                                   StochasticDiffEqNewtonAlgorithm{CS, AD,
                                                                                   FDT, ST,
                                                                                   CJ,
                                                                                   Controller
                                                                                   }}) where {
...
@static if isdefined(OrdinaryDiffEq, :alg_difftype)
    function OrdinaryDiffEq.alg_difftype(alg::Union{
                                                    StochasticDiffEqNewtonAdaptiveAlgorithm{
                                                                                            CS,
                                                                                            AD,
                                                                                            FDT,
...
@static if isdefined(OrdinaryDiffEq, :concrete_jac)
    function OrdinaryDiffEq.concrete_jac(alg::Union{
                                                    StochasticDiffEqNewtonAdaptiveAlgorithm{
                                                                                            CS,
                                                                                            AD,
                                                                                            FDT,
...
function alg_mass_matrix_compatible(alg::Union{StochasticDiffEqNewtonAlgorithm,
                                               StochasticDiffEqNewtonAdaptiveAlgorithm})
    if alg.symplectic
        return true
    elseif alg.theta == 1
