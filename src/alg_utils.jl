...
alg_order(alg::SplitStepEM) = 1//2
alg_order(alg::SplitStepEulerHeun) = 1//2
...
alg_compatible(prob,alg::SplitStepEM) = true
alg_compatible(prob,alg::SplitStepEulerHeun) = true
