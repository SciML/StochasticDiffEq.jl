...
function OrdinaryDiffEqCore._initialize_dae!(integrator::Union{AbstractSDEIntegrator, AbstractSDDEIntegrator}, prob::Union{SciMLBase.AbstractRODEProblem, SciMLBase.AbstractSDDEProblem}, ::OrdinaryDiffEqCore.DefaultInit, isinplace)
