...
function OrdinaryDiffEqCore._initialize_dae!(integrator::Union{AbstractSDEIntegrator, AbstractSDDEIntegrator}, prob::SciMLBase.AbstractSDEProblem, ::OrdinaryDiffEqCore.DefaultInit, isinplace)
