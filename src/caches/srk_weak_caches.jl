...
function DRI1ConstantCache(::Type{T}, ::Type{T2}) where {T, T2}
    ...
    DRI1ConstantCache(a021, a031, a032, a121, a131, b021, b031, b121, b131, b221, b222,
                      b223, b231, b232, b233, α1, α2, α3, c02, c03, c12, c13, beta11,
                      beta12, beta13, beta22, beta23, beta31, beta32, beta33, beta42,
                      beta43, NORMAL_ONESIX_QUANTILE)
end

function alg_cache(alg::DRI1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RI1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RI3, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RI5, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RI6, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RDI2WM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RDI3WM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RDI4WM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
@cache struct DRI1Cache{uType, randType, tabType, rateNoiseType, rateType, possibleRateType
...
@cache struct DRI1NMCache{uType, randType, tabType, rateNoiseType, rateType,
                          possibleRateType} <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
    uhat::uType
...
function alg_cache(alg::DRI1, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    DRI1Cache(u, uprev, uhat, _dW, _dZ, chi1, tab, g1, g2, g3, k1, k2, k3, H02, H03, H12,
              H13, H22, H23, tmp1, tmpg, tmp, resids)
end
...
function alg_cache(alg::DRI1NM, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    DRI1NMCache(u, uprev, uhat, _dW, chi1, tab, g1, g2, g3, k1, k2, k3, H02, H03, H12, H13,
                tmp1, tmpg, tmp, resids)
end
...
function alg_cache(alg::RDI1WM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
@cache struct RDI1WMCache{uType, randType, tabType, rateNoiseType, rateType,
                          possibleRateType} <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
...
function RS1ConstantCache(T::Type, T2::Type)
    ...
    RSConstantCache(a021, a031, a032, a131, a141, b031, b032, b121, b131, b132, b141, b142,
                    b143, b221, b231, b331, b332, b341, b342, α1, α2, α3, α4, c02, c03, c13,
                    c14, beta11, beta12, beta13, beta14, beta22, beta23,
                    NORMAL_ONESIX_QUANTILE)
end

function alg_cache(alg::RS1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::RS2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
@cache struct RSCache{uType, randType, tabType, rateNoiseType, rateType, possibleRateType
                      } <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
...
function alg_cache(alg::RS1, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    RSCache(u, uprev, _dW, _dZ, chi1, tab, g1, g2, g3, g4, k1, k2, k3, H02, H03, H12, H13,
            H14, H22, H23, tmp1, tmpg)
end
...
function alg_cache(alg::PL1WM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::PL1WMA, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
@cache struct PL1WMCache{uType, randType, rand2Type, tabType, rateNoiseType, rateType,
                         possibleRateType} <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
...
function alg_cache(alg::PL1WM, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    PL1WMCache(u, uprev, _dW, _dZ, chi1, tab, g1, k1, k2, Y, Yp, Ym, tmp1, tmpg1, tmpg2,
               Ulp, Ulm)
end

# additive noise
@cache struct PL1WMACache{uType, randType, tabType, rateNoiseType, rateType,
                          possibleRateType} <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
...
function NONConstantCache(T::Type)
    ...
    NONConstantCache(c01, c02, c03, c04, cj1, cj2, cj3, cj4, cjl2, cjl3, clj2, clj3, a0021,
                     a0032, a0043, aj021, aj041, a0j21, a0j31, a0j32, a0j41, ajj21, ajj31,
                     ajj32, ajj41, ajj42, ajj43, ajl31, ajl32, ajl41, ajl42, ajljj31,
                     aljjl21, aljjl31, NORMAL_ONESIX_QUANTILE)
end

function alg_cache(alg::NON, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::NON, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    NONCache(u, uprev, _dW, _dZ, chi1, tab, gtmp, ktmp, Y100, Y200, Y300, Y400, Y1jajb,
             Y2jajb, Y3jajb, Y4jajb, tmpu)
end
...
function alg_cache(alg::COM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::COM, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    COMCache(u, uprev, _dW, tab, gtmp, ktmp, Y10, Y20, Y30, Y40, Y1j, Y2j, Y3j, Y4j, tmpu,
             tmpu2)
end
...
function alg_cache(alg::NON2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::NON2, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    NON2Cache(u, uprev, _dW, _dZ, chi1, Ihat2, tab, gtmp, gtmp1, ktmp, Y10, Y20, Y30, Y40,
              Y1j, Y2j, Y3j, Y4j, tmpu, tmpu2)
end
...
function alg_cache(alg::SIEA, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SMEA, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SIEB, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SMEB, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
