...
function alg_cache(alg::SRA1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
...
function alg_cache(alg::SRA, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SRA, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    E₁ = zero(rate_prototype)
    tmp = zero(u)
    SRACache(u, uprev, H0, A0temp, B0temp, ftmp, gtmp, chi2, atemp, btemp, E₁, E₁temp, E₂,
             tmp, tab)
end
