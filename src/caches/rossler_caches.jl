...
function alg_cache(alg::SRI, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
...
function alg_cache(alg::SRI, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    tmp = zero(u)
    SRICache(u, uprev, H0, H1, A0temp, A1temp, B0temp, B1temp, A0temp2, A1temp2, B0temp2,
             B1temp2,
             atemp, btemp, E₁, E₂, E₁temp, ftemp, gtemp, chi1, chi2, chi3, tmp, tab)
end

struct SRIW1ConstantCache <: StochasticDiffEqConstantCache end
function alg_cache(alg::SRIW1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SRIW1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    g₄ = zero(rate_prototype)
    tmp = zero(u)
    SRIW1Cache(u, uprev, chi1, chi2, chi3, fH01o4, g₁o2, H0, H11, H12, H13, g₂o3, Fg₂o3,
               g₃o3, Tg₃o3, mg₁, E₁, E₂, fH01, fH02, g₁, g₂, g₃, g₄, tmp)
end
...
function SRIW2ConstantCache(T::Type, T2::Type)
    ...
    FourStageSRIConstantCache(a021, a031, a032, a041, a042, a043, a121, a131, a132, a141,
                              a142, a143, b021, b031, b032, b041, b042, b043, b121, b131,
                              b132, b141, b142, b143, α1, α2,
                              α3, α4, c02, c03, c04, c11, c12, c13, c14, beta11, beta12,
                              beta13, beta14, beta21, beta22,
                              beta23, beta24, beta31, beta32, beta33, beta34, beta41,
                              beta42, beta43, beta44)
end
...
@cache struct FourStageSRICache{uType, randType, tabType, rateNoiseType, rateType,
...
function alg_cache(alg::SRIW2, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    FourStageSRICache(u, uprev, chi1, chi2, chi3, tab, g1, g2, g3, g4, k1, k2, k3, k4, E₁,
                      E₂, tmp, tmp, tmp)
end
