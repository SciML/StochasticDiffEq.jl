...
function alg_cache(alg::algType, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    caches = map((x) -> alg_cache(x, prob, u, ΔW, ΔZ, p, rate_prototype,
                                  noise_rate_prototype, jump_rate_prototype, uEltypeNoUnits,
                                  uBottomEltypeNoUnits, tTypeNoUnits, uprev, f, t, dt,
                                  Val{T}), alg.algs)
