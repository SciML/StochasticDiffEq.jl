...
function alg_cache(alg::SROCK1, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
...
function alg_cache(alg::SROCK2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SROCK2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    SROCK2Cache(u, uprev, uᵢ, uₓ, uᵢ₋₁, uᵢ₋₂, Gₛ, Gₛ₁, WikRange, vec_χ, tmp, k, fsalfirst,
                atmp, constantcache)
end
...
function alg_cache(alg::SROCKEM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SROCKEM, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    uᵢ₋₂ = zero(u)
    Gₛ = zero(noise_rate_prototype)
    if (!alg.strong_order_1 || is_diagonal_noise(prob) || typeof(ΔW) <: Number ||
        length(ΔW) == 1)
        Gₛ₁ = Gₛ
    else
        Gₛ₁ = zero(noise_rate_prototype)
    ...
    SROCKEMCache(u, uprev, uᵢ₋₁, uᵢ₋₂, Gₛ, Gₛ₁, tmp, k, fsalfirst, WikRange, atmp,
                 constantcache)
end
...
@cache struct SKSROCKCache{uType, rateType, noise_rate_prototype, T,
                           C <: SKSROCKConstantCache} <: StochasticDiffEqMutableCache
    u::uType
    uprev::uType
    uᵢ₋₁::uType
    uᵢ₋₂::uType
...
function alg_cache(alg::SKSROCK, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
@cache struct TangXiaoSROCK2Cache{uType, rateType, noiseRateType,
                                  C <: TangXiaoSROCK2ConstantCache} <:
              StochasticDiffEqMutableCache
    u::uType
    uprev::uType
    uᵢ::uType
...
function alg_cache(alg::TangXiaoSROCK2, prob, u, ΔW, ΔZ, p, rate_prototype,
...
function alg_cache(alg::TangXiaoSROCK2, prob, u, ΔW, ΔZ, p, rate_prototype,
    ...
    TangXiaoSROCK2Cache(u, uprev, uᵢ, uₓ, Û₁, Û₂, uᵢ₋₁, uᵢ₋₂, Gₛ, Gₛ₁, tmp, k, fsalfirst,
                        atmp, constantcache)
end
...
@cache struct KomBurSROCK2Cache{uType, rateType, noiseRateType, T,
                                C <: KomBurSROCK2ConstantCache} <:
              StochasticDiffEqMutableCache
    u::uType
    uprev::uType
    utmp::uType
...
function alg_cache(alg::KomBurSROCK2, prob, u, ΔW, ΔZ, p, rate_prototype,
                   noise_rate_prototype, jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SROCKC2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::SROCKC2, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    SROCKC2Cache(u, uprev, uᵢ, uᵢ₋₁, uᵢ₋₂, Gₛ, Gₛ₁, WikRange, tmp, k, fsalfirst, atmp,
                 constantcache)
end
