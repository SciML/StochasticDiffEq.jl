...
function alg_cache(alg::IIF1M, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
...
function alg_cache(alg::IIF1M, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    IIF1MCache(u, uprev, uhold, dual_cache, tmp, rhs, nl_rhs, rtmp1, rtmp2, rtmp3,
               noise_tmp)
end
...
function alg_cache(alg::IIF2M, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::IIF2M, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    IIF2MCache(u, uprev, uhold, dual_cache, tmp, rhs, nl_rhs, rtmp1, rtmp2, rtmp3,
               noise_tmp)
end
...
function alg_cache(alg::IIF1Mil, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
                   jump_rate_prototype, ::Type{uEltypeNoUnits},
                   ::Type{uBottomEltypeNoUnits}, ::Type{tTypeNoUnits}, uprev, f, t, dt,
                   ::Type{Val{false}}) where {uEltypeNoUnits, uBottomEltypeNoUnits,
                                              tTypeNoUnits}
...
function alg_cache(alg::IIF1Mil, prob, u, ΔW, ΔZ, p, rate_prototype, noise_rate_prototype,
    ...
    IIF1MilCache(u, uprev, uhold, dual_cache, tmp, rhs, nl_rhs, rtmp1, rtmp2, rtmp3,
                 noise_tmp, gtmp, gtmp2)
end
