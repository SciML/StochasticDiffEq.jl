@muladd function perform_step!(integrator,cache::SplitEMConstantCache,f::F=integrator.f) where F
...
@muladd function perform_step!(integrator,cache::SplitEMCache,f::F=integrator.f) where F
