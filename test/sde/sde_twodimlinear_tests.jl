...
sim = test_convergence(dts,prob,TXSROCK2(version_num=1),numMonte=100)
@test abs(sim.𝒪est[:l∞]- 1) < 0.2

sim = test_convergence(dts,prob,TXSROCK2(version_num=2),numMonte=100)
@test abs(sim.𝒪est[:l∞]- 1) < 0.2

sim = test_convergence(dts,prob,TXSROCK2(version_num=3),numMonte=100)
@test abs(sim.𝒪est[:l∞]- 1) < 0.2

sim = test_convergence(dts,prob,TXSROCK2(version_num=4),numMonte=100)
@test abs(sim.𝒪est[:l∞]- 1) < 0.2

sim = test_convergence(dts,prob,TXSROCK2(version_num=5),numMonte=100)
@test abs(sim.𝒪est[:l∞]- 1) < 0.2
