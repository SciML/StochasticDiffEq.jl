...
@test abs(sim.𝒪est[:l2] - 0.5) + abs(sim2.𝒪est[:l∞] - 1) + abs(sim3.𝒪est[:final] - 1.5) <
      0.441  #High tolerance since low dts for testing!

@test abs(sim.𝒪est[:l2] - 0.5) + abs(sim21.𝒪est[:l∞] - 1) + abs(sim3.𝒪est[:final] - 1.5) <
      0.441  #High tolerance since low dts for testing!
